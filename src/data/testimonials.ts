...
export interface Testimonial {
	/** Short pull line shown first (cards + carousel). */
	highlight: string;
...
export const testimonials: readonly Testimonial[] = [
	{
		highlight: 'Highly recommend — knowledgeable advice, prompt work, and a finish you can trust.',
		quote:
	...
	{
		highlight:
			'Pulled a skilled team together fast — brilliant speed, quality, and value for a sale-ready home.',
		quote:
	...
	{
		highlight: 'Always available and proactive — a godsend across renovations and emergencies.',
		quote:
	...
	{
		highlight: 'Organised the right trades quickly on a demanding prep — excellent quality end to end.',
		quote:
	...
	{
		highlight: 'Reliable and urgent when it mattered — from poor condition to tenant-ready, fast.',
		quote:
...
/** Single centred pull-quote under breather stats: real client, shortened for this band only. */
